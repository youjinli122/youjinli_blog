...
- eact 通过提供机制把应用状态转换为可渲染组件树并对其进行渲染
  ...
  ![cmd-markdown-logo](https://cn.mobx.js.org/flow.png)
...
- 修饰器本质就是编译时执行的函数
  8 如果想添加实例属性，可以通过目标类的 prototype 对象操作
...
- 谁用到了可观察属性，就需要被 observer 修饰，按需渲染
