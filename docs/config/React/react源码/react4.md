...
- 请说一下 React 合成事件的工作原理?
- 可以给函数组件绑定事件吗?为什么?

  2.2 使用
  ![cmd-markdown-logo](https://img.zhufengpeixun.com/5f3ce0fe2ec27f8644983e7d8f31c367)
...
![cmd-markdown-logo](https://img.zhufengpeixun.com/f5567dd756ad8b372fcdf12ece2477a8)
